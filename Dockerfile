# Replace with a CUDA/cuDNN/Ubuntu base image that matches your environment
# You can find options at https://hub.docker.com/r/nvidia/cuda/tags
...
RUN conda tos accept --override-channels --channel https://repo.anaconda.com/pkgs/main && \
    conda tos accept --override-channels --channel https://repo.anaconda.com/pkgs/r && \
    conda install -y pip && \
    conda install -y -c rdkit nox && \
    conda install -y cairo && \
    conda install -y -c conda-forge jupyterlab notebook ipykernel pandas matplotlib
