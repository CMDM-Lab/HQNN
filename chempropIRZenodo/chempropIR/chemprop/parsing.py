...
def add_predict_args(parser: ArgumentParser):
    ...
    parser.add_argument('--no_cuda', action='store_true', default=False,
                        help='Turn off cuda')
    parser.add_argument('--features_generator', type=str, nargs='*', default=['morgan'],
...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--features_only', action='store_true', default=True,
    ...
    parser.add_argument('--metric', type=str, default='sid',
    ...
    parser.add_argument('--normalization_start', type=int, default=50,
    ...
    parser.add_argument('--normalization_end', type=int, default=550,
                        help='Option for spectral outputs. Normalizes the outputs within the specified range'
                        'to sum to one. To normalize over all targets, specify 0 as the start and no end.'
    ...
    parser.add_argument('--no_features_scaling', action='store_true', default=True,
